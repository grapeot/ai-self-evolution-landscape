  ...
  regions: [
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/good-1965.html', relevance: '智能爆炸概念的原始出处', tier: 'primary' },
        { title: '智能爆炸 FAQ — MIRI', url: 'https://intelligence.org/ie-faq/',
        translatedUrl: '/translations/miri-faq.html', relevance: '最系统的论证框架', tier: 'primary' },
        { title: 'AI 开始构建自己 — TechCrunch (2026)', url: 'https://techcrunch.com/2026/05/14/what-happens-when-ai-starts-building-itself/',
        translatedUrl: '/translations/techcrunch-2026.html', relevance: 'Socher 将 Good 愿景商业化的尝试', tier: 'primary' },
        { title: 'MIRI 对 Chollet 的回复 (2017)', url: 'https://intelligence.org/2017/12/06/chollet/',
        translatedUrl: '/translations/miri-chollet.html', relevance: '理解正反双方核心分歧的最佳单一来源', tier: 'primary' },
      ],
    },
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/alphazero-tds.html', relevance: '大师级棋手撰写的技术细节全解', tier: 'primary' },
        ...
        translatedUrl: '/translations/selfplay-medium.html', relevance: 'AlphaGo→AlphaZero→MuZero→OpenAI Five 完整演进', tier: 'supporting' },
        ...
        translatedUrl: '/translations/alphaevolve-2025.html', relevance: '架构、方法、初始成果', tier: 'primary' },
        { title: 'AlphaEvolve 影响力 — Google DeepMind (2026)', url: 'https://deepmind.google/blog/alphaevolve-impact/',
        translatedUrl: '/translations/alphaevolve-impact.html', relevance: '跨域扩展：基因组学、量子、物流', tier: 'primary' },
        ...
        translatedUrl: '/translations/automl-zero-blog.html', relevance: '入门解读', tier: 'supporting' },
        { title: 'Self-Improving AI Guide 2026 — o-mega', url: 'https://o-mega.ai/articles/self-improving-ai-agents-the-2026-guide',
        translatedUrl: '/translations/self-improving-guide.html', relevance: '可验证性约束的系统分析', tier: 'supporting' },
        { title: '开源复现论文 (2025)', url: 'https://arxiv.org/html/2510.14150v2',
        translatedUrl: '/translations/codeevolve.html', relevance: '用开源模型超越 AlphaEvolve 在部分问题上', tier: 'counterpoint' },
        { title: 'AlphaEvolve 独立评测 — Ernest Davis (NYU)', url: 'https://cs.nyu.edu/~davise/papers/AlphaEvolveNotes.pdf',
        translatedUrl: '/translations/alphaevolve-review.html', relevance: '学术评审：增量性质，TPU 改进被独立发现', tier: 'counterpoint' },
      ],
    },
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/nested-learning.html', relevance: '核心理论、三大技术贡献、HOPE', tier: 'primary' },
        { title: 'HOPE 详解 — AI Papers Academy (2026)', url: 'https://aipapersacademy.com/nested-learning-hope/',
        translatedUrl: '/translations/hope-detail.html', relevance: 'NLM、CMS、自修改机制、benchmark', tier: 'primary' },
        ...
        translatedUrl: '/translations/hope-review.html', relevance: '指出 scale 局限', tier: 'counterpoint' },
        { title: 'Darwin Godel Machine — Sakana AI', url: 'https://sakana.ai/darwin-godel-machine/',
        translatedUrl: '/translations/dgm.html', relevance: 'SWE-bench 20%→50%', tier: 'primary' },
        { title: 'HyperAgents / DGM-H — Meta AI (2026)', url: 'https://arxiv.org/abs/2603.19461',
        translatedUrl: '/translations/hyperagents.html', relevance: '元认知自改进：元级修改过程本身可编辑，跨域迁移', tier: 'primary' },
      ],
    },
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/ai-scientist.html', relevance: '多 agent tournament 架构，三项实验室验证', tier: 'primary' },
        { title: 'HyperAgents / DGM-H — Meta AI (2026)', url: 'https://arxiv.org/abs/2603.19461',
        translatedUrl: '/translations/hyperagents.html', relevance: '元认知自改进：元级修改过程可编辑，跨域迁移', tier: 'primary' },
    ...
    },
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/recursive-tnw.html', relevance: '最详细人物+路线图，含批判视角', tier: 'primary' },
        ...
        translatedUrl: '/translations/recursive-unite.html', relevance: '开放式进化+rainbow teaming', tier: 'primary' },
        { title: 'IEEE Spectrum RSI 全景 (2026)', url: 'https://spectrum.ieee.org/recursive-self-improvement',
        translatedUrl: '/translations/ieee-rsi.html', relevance: '覆盖所有玩家和专家观点', tier: 'primary' },
        { title: 'Dean Ball: 论 RSI (2026)', url: 'https://www.hyperdimensional.co/p/on-recursive-self-improvement-part',
        translatedUrl: '/translations/dean-ball.html', relevance: '冷静分析：最重要的不是是否而是如何', tier: 'primary' },
    ...
    },
    {
      ...
      articles: [
        ...
        translatedUrl: '/translations/chollet-2017.html', relevance: '五条论证，最著名反驳', tier: 'primary' },
        { title: '有损自改进 — Lambert (2026)', url: 'https://www.interconnects.ai/p/lossy-self-improvement',
        translatedUrl: '/translations/lambert-lsi.html', relevance: '工程摩擦分析', tier: 'primary' },
        ...
        translatedUrl: '/translations/harjas-rsi.html', relevance: '技术树框架', tier: 'primary' },
        { title: 'IEEE Spectrum RSI 全景 (2026)', url: 'https://spectrum.ieee.org/recursive-self-improvement',
        translatedUrl: '/translations/ieee-rsi.html', relevance: '含 Ball、Krueger、Clune 审慎观点', tier: 'primary' },
        { title: 'AlphaEvolve 独立评测 — Davis (NYU)', url: 'https://cs.nyu.edu/~davise/papers/AlphaEvolveNotes.pdf',
        translatedUrl: '/translations/alphaevolve-review.html', relevance: '可验证性约束证据', tier: 'supporting' },
        { title: 'MIRI 对 Chollet 回复 (2017)', url: 'https://intelligence.org/2017/12/06/chollet/',
        translatedUrl: '/translations/miri-chollet.html', relevance: 'Yudkowsky 逐条反驳', tier: 'counterpoint' },
      ],
    },
  ],
  tensions: [
